# CentOSStream 9 kickstart file for Vagrant boxes

# url --mirrorlist=http://mirrorlist.centos.org/?release=9&arch=x86_64&repo=BaseOS&infra=stock
# repo --name=AppStream --mirrorlist=http://mirrorlist.centos.org/?release=9&arch=x86_64&repo=AppStream&infra=stock
...
firewall --disabled
services --enabled=vmtoolsd,sshd
